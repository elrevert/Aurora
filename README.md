...
2. Aurora is a fully fledged I/O label editor. You can use it to change the labels of your inputs, outputs and busses. You can also save, export and import I/O label presets, allowing for easy switching between different I/O & bus configurations.
...
0. (If you want Aurora to show whether plugin updates are available) Install [KVR Studio Manager](https://www.kvraudio.com/kvr-studio-manager), open it, run a scan and hit 'Sync with KVR'. This step is completely optional.
...
- When doing scans in KVR Studio Manager, make sure to hit 'Sync with KVR' after the scan is complete. 
<br>
...
Just use the app and report any bugs you find. The main goal of the alpha is to test the I/O label functionality with as many different audio interfaces as possible.
<br>
<br>
