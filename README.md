...
3. Right-click -> Open
4. Depending on your Gatekeeper configuration, you may need to complete the following steps: System Preferences -> Privacy and Security -> Open Anyway.
